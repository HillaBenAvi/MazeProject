...
import static Server.Server.Configuration.getGeneratorPropString;
...
public class ServerStrategyGenerateMaze implements ISreverStrategy {
    ...
    public String serverStrategy(InputStream inFromClient, OutputStream outToClient) {
        try {
            ...
            byteOutput.close();
            //objectOutput.close();
            return "Maze created. Number of rows:"+maze.getRows() + ", number of columns:"+maze.getColumns()+". Generated by:" + getGeneratorPropString();
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
